...
model SynchronousGenerator_NoTransVoltModel
...
equation
  ...
  // magnetic flux linkage equations (from [1] eq. 3.127-3.132)
  ...
  // voltage equations (from [1] eq. 3.120-3.125)
  v_d = - R_s*i_d - Psi_q*omega_e; // stator
  v_q = - R_s*i_q + Psi_d*omega_e;
...
end SynchronousGenerator_NoTransVoltModel;
